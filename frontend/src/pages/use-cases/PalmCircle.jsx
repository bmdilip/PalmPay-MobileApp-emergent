...
import { 
  ...
  Sliders, History, CreditCard, Smartphone
} from 'lucide-react';
...
const PalmCircle = () => {
  ...
  const [activeTab, setActiveTab] = useState('members'); // members, requests, activity
  ...
  const [addMethod, setAddMethod] = useState(null); // 'qr', 'phone', 'palmid'
  
  // Form states
  const [newMemberPhone, setNewMemberPhone] = useState('');
  const [newMemberName, setNewMemberName] = useState('');
  const [newMemberRelation, setNewMemberRelation] = useState('');
  const [accessMode, setAccessMode] = useState('limited'); // 'limited' or 'approval'
  ...
  // Mock members data (based on UPI Circle features)
  const mockMembers = [
    {
      id: 'm1',
      name: 'Priya Sharma',
      ...
      relation: 'spouse',
      palmId: 'PLM-PRIYA-2024',
      palmRegistered: true,
      accessMode: 'limited', // 'limited' or 'approval'
      dailyLimit: 5000,
      perTxnLimit: 2000,
      monthlyLimit: 15000,
      monthlySpent: 4500,
    ...
    },
    {
      ...
      relation: 'child',
      palmId: 'PLM-ARYAN-2024',
      palmRegistered: true,
      accessMode: 'approval', // Requires approval for each transaction
      dailyLimit: 1000,
      perTxnLimit: 500,
      monthlyLimit: 5000,
      monthlySpent: 2200,
  ...
  const recentActivity = [
    { id: 'a1', member: 'Priya Sharma', action: 'Paid', amount: 350, merchant: 'BigBasket', time: '10 mins ago', status: 'completed' },
    { id: 'a2', member: 'Aryan', action: 'Requested', amount: 450, merchant: 'Zomato', time: '5 mins ago', status: 'pending' },
    { id: 'a3', member: 'Mom', action: 'Paid', amount: 1200, merchant: 'Apollo Pharmacy', time: 'Yesterday', status: 'completed' },
    { id: 'a4', member: 'Aryan', action: 'Paid', amount: 150, merchant: 'Metro', time: 'Yesterday', status: 'completed' },
    { id: 'a5', member: 'Priya Sharma', action: 'Paid', amount: 2500, merchant: 'DMart', time: '2 days ago', status: 'completed' }
  ];
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-pink-100">Family wallet • Delegate payments</p>
            </div>
          </div>
          <button 
        ...
        {activeTab === 'members' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <Card className="p-4 mb-4 bg-gradient-to-r from-pink-50 to-rose-50 border-pink-200">
              <div className="flex items-center gap-3">
                <PalmNFCIcon className="w-8 h-8" style={{ filter: 'brightness(0) saturate(100%) invert(27%) sepia(51%) saturate(2878%) hue-rotate(330deg)' }} />
                <div className="flex-1">
                  <h4 className="font-semibold text-gray-800">Phone-Free Payments</h4>
                  <p className="text-xs text-gray-600">Members pay with palm, you stay in control</p>
                </div>
              </div>
            </Card>
              ...
              <div className="p-5">
                ...
                {addMethod === 'phone' && (
                  <div className="space-y-4">
                    ...
                    {/* Access Mode - Key UPI Circle Feature */}
                    <div>
